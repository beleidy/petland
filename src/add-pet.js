...
class AddPet extends Component{
        ...
        **********************************************************************************************/
        ...
        //1. If the user is signed in
            ...
            if (!this.state.isFileUpload){
                ...
                const fileIsImage = this.state.uploadFile.type.startsWith("image");
                if (fileIsImage){
                    ...
                    this.setState({errorMessage: "The file you selected is not an image. Please select another one."});
                    return null;
                }
            }
                }
    ...
    startUpload(imageBlob){
        ...
        const fileName = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function(c) {
        ...
        uploadTask.on("state_changed", (snapshot)=>{
            ...
            console.log('Upload is ' + progress + '% done');
                ...
                const dbNewPet = {name: this.state.petName, imageURL: imageDbLink, ownerId: ownerId};
                //Push new pet information to firebase
                var dbPush = firebase.database().ref().child('/pets/').push(dbNewPet);
    ...
    //Function that handles upload of file
    submitFile(file){
        ...
        return(
            ...
            {this.state.isSignedIn ?
                (<Form className="add-pet-form" onSubmit={this.handleSubmit}>
                    ...
                    <Button variant="raised" color={"primary"} >Add my pet</Button>
                </Form>)
